...
class SwishAgreementModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(SwishAgreementModel::getClassName());
        $model = SwishAgreementModel::fromArray($json);
        $this::assertSame('string', $model->getSwishNumber());
    }
}
