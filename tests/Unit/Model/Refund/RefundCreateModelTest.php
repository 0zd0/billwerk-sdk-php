...
namespace Billwerk\Sdk\Test\Unit\Model\Refund;
...
class RefundCreateModelTest extends TestCase
{
    ...
    public function testFromArrayMethodWithRequiredFields()
    {
        ...
        $this::assertSame(null, $model->getManualTransfer());
    ...
    public function testFromArrayMethodWithAllFields()
    {
        ...
        $this::assertInstanceOf(ManualTransferModel::class, $model->getManualTransfer());
