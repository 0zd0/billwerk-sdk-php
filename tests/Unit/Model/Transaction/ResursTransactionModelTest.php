...
class ResursTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(ResursTransactionModel::getClassName());
        $model = ResursTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getResursId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(ResursTransactionModel::getClassName());
        $model = ResursTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0075', $model->getResursId());
    }
}
