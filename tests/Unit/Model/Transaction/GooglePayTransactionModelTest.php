...
class GooglePayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(GooglePayTransactionModel::getClassName());
        $model = GooglePayTransactionModel::fromArray($json);
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(GooglePayTransactionModel::getClassName());
        $model = GooglePayTransactionModel::fromArray($json);
