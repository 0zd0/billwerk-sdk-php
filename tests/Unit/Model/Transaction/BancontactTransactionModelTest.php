...
class BancontactTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(BancontactTransactionModel::getClassName());
        $model = BancontactTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getBancontactId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(BancontactTransactionModel::getClassName());
        $model = BancontactTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getBancontactId());
    }
}
