...
class VippsTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(VippsTransactionModel::getClassName());
        $model = VippsTransactionModel::fromArray($json);
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(VippsTransactionModel::getClassName());
        $model = VippsTransactionModel::fromArray($json);
