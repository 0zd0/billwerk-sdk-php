...
class MultibancoTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(MultibancoTransactionModel::getClassName());
        $model = MultibancoTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getMultibancoId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(MultibancoTransactionModel::getClassName());
        $model = MultibancoTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getMultibancoId());
    }
}
