...
class OfflineTransactionModelTest extends TestCase
{
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(\Billwerk\Sdk\Model\Transaction\OfflineTransactionModel::getClassName());
        $model = \Billwerk\Sdk\Model\Transaction\OfflineTransactionModel::fromArray($json);
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(\Billwerk\Sdk\Model\Transaction\OfflineTransactionModel::getClassName());
        $model = \Billwerk\Sdk\Model\Transaction\OfflineTransactionModel::fromArray($json);
