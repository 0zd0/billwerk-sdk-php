...
class ViabillTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(ViabillTransactionModel::getClassName());
        $model = ViabillTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getViabillId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(ViabillTransactionModel::getClassName());
        $model = ViabillTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0075', $model->getViabillId());
    }
}
