...
use Billwerk\Sdk\Model\Transaction\VippsRecurringTransactionModel;
use Billwerk\Sdk\Test\StubTrait;
use Billwerk\Sdk\Test\TestCase;
use Exception;

class VippsRecurringTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(VippsRecurringTransactionModel::getClassName());
        $model = VippsRecurringTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0075', $model->getVippsRecurringId());
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(VippsRecurringTransactionModel::getClassName());
        $model = VippsRecurringTransactionModel::fromArray($json);
