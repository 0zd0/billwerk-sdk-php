...
class LatviaBanksTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(LatviaBanksTransactionModel::getClassName());
        $model = LatviaBanksTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getLatviaBanksId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(LatviaBanksTransactionModel::getClassName());
        $model = LatviaBanksTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getLatviaBanksId());
    }
}
