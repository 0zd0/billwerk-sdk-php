...
class BancomatpayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(BancomatpayTransactionModel::getClassName());
        $model = BancomatpayTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getBancomatpayId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(BancomatpayTransactionModel::getClassName());
        $model = BancomatpayTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0075', $model->getBancomatpayId());
    }
}
