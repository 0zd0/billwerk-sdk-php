...
class PayseraTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(PayseraTransactionModel::getClassName());
        $model = PayseraTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getPayseraId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(PayseraTransactionModel::getClassName());
        $model = PayseraTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getPayseraId());
    }
}
