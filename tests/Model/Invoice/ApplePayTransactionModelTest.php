...
class ApplePayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(ApplePayTransactionModel::getClassName());
        $model = ApplePayTransactionModel::fromArray($json);
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(ApplePayTransactionModel::getClassName());
        $model = ApplePayTransactionModel::fromArray($json);
