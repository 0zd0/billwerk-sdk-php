...
class SatispayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(SatispayTransactionModel::getClassName());
        $model = SatispayTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getSatispayId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(SatispayTransactionModel::getClassName());
        $model = SatispayTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getSatispayId());
    }
}
