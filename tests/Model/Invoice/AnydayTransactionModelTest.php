...
class AnydayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(AnydayTransactionModel::getClassName());
        $model = AnydayTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getAnydayId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(AnydayTransactionModel::getClassName());
        $model = AnydayTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0075', $model->getAnydayId());
    }
}
