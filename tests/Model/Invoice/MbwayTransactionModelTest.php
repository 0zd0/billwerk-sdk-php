...
class MbwayTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(MbwayTransactionModel::getClassName());
        $model = MbwayTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getMbWayId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(MbwayTransactionModel::getClassName());
        $model = MbwayTransactionModel::fromArray($json);
        ...
        $this::assertSame('aa8400fd1245e991ce1ee20780168839', $model->getMbWayId());
    }
}
