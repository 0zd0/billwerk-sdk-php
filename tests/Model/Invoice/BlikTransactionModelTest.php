...
class BlikTransactionModelTest extends TestCase
{
    use StubTrait;
    ...
    {
        $json  = $this::getStubJsonModelWithRequiredFields(BlikTransactionModel::getClassName());
        $model = BlikTransactionModel::fromArray($json);
        ...
        $this::assertSame(null, $model->getBlikId());
    }
    ...
    {
        $json  = $this::getStubJsonModelWithAllFields(BlikTransactionModel::getClassName());
        $model = BlikTransactionModel::fromArray($json);
        ...
        $this::assertSame('28fc559a229e4fd3a134297a478a0070', $model->getBlikId());
    }
}
